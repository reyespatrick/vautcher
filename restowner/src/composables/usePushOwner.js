// Web-Push subscribe flow for a (pending) owner. Same as usePushAdmin but
// registers via the ungated vautcher_register_owner_push RPC, so a not-yet-
// approved owner can opt in to be notified the moment root approves them.
import { ref } from 'vue'
...
export function usePushOwner() {
  ...
  async function enable() {
    ...
    try {
      ...
      const { error } = await supabase.rpc('vautcher_register_owner_push', {
