...
const fr = {
  ...
  editor: {
    ...
    notifyHint: 'Annoncez l’événement à tous les abonnés dès sa validation, et/ou programmez un rappel quelques jours avant. Les deux sont cumulables.',
    savedTitle: 'Événement enregistré',
    savedPending: '⏳ En attente de validation. La notification partira une fois l’événement validé par un modérateur.',
    savedAnnounced: '📣 L’annonce est envoyée à tous vos abonnés.',
    savedReminder: '⏰ Rappel programmé le {date} vers 11h00, à tous vos abonnés.',
    savedNone: 'Aucune notification n’est configurée pour cet événement.',
    savedPushNowQ: 'Envoyer ce rappel maintenant ? La notification programmée sera alors annulée.',
    pushNow: 'Envoyer maintenant',
    keepSchedule: 'Garder la programmation',
    pushSentTitle: 'Notification envoyée',
    pushSentBody: 'La notification part vers vos abonnés. Le rappel programmé a été annulé.',
    pushFailedTitle: 'Échec de l’envoi',
    pushFailed: 'La notification n’a pas pu être envoyée. Réessayez depuis le tableau de bord.',
    aiRephrase: 'Améliorer avec l’IA',
    aiBusy: 'Amélioration…',
    aiHint: 'Reformule joliment votre texte, en 200 caractères max.',
    aiTitle: 'Reformulation IA',
    aiEmpty: 'Écrivez d’abord une description à améliorer.',
    aiFailed: 'La reformulation a échoué. Réessayez.',
    ...
    deleteBtn: 'Supprimer',
    confirmDeleteTitle: 'Supprimer l’événement/offre ?',
    confirmDelete: 'Supprimer définitivement ? Cette action est irréversible et retire aussi les inscriptions.',
  ...
  vouchers: {
    ...
    deleteBody: 'Supprimer « {label} » ? Les cartes déjà en cours chez les clients ne sont pas affectées.',
  ...
  admin: {
    ...
    discoverBtn: 'Découvrir à proximité',
    queueTitle: 'File de traitement',
    queuePending: '{n} en attente',
    queueScaffolding: '{n} en cours de traitement',
    queueDone: '{n} terminé(s)',
    queueFailed: '{n} échec(s)',
    queueCurrent: 'En cours de traitement : {name}',
    ...
    scaffoldRowPending: 'Création du site en cours…',
    manualCreate: 'Créer manuellement',
    regenerate: 'Régénérer',
    regenerateTitle: 'Régénérer {name} ?',
    ...
    sourceUrlEdit: 'Modifier le site source',
    sourceUrlSet: 'Définir le site source',
    sourceUrlLabel: 'URL du site source',
    sourceUrlHint: 'À la sauvegarde, le site sera automatiquement régénéré depuis cette URL.',
    sourceUrlSave: 'Enregistrer et régénérer',
    sourceUrlSaving: 'Enregistrement…',
    deleteBtn: 'Supprimer',
    ...
    notifOk: 'Notifications activées. Vous serez prévenu quand un site que vous générez est en ligne.',
    notifFailed: 'Activation impossible. Autorisez les notifications dans le navigateur (et installez l’app sur iOS).',
  ...
  queue: {
    ...
    subtitle: 'Détail des restaurants en attente, en cours de traitement, terminés ou en échec.',
    empty: 'La file est vide.',
    bucketScaffolding: 'En cours de traitement',
    bucketPending: 'En attente ({n})',
    bucketDone: 'Terminés ({n})',
    bucketFailed: 'Échecs ({n})',
    enqueuedAt: 'Ajouté à {t}',
    startedAt: 'Démarré à {t}',
    finishedAt: 'Terminé à {t}',
    failedAt: 'Échec à {t}',
    viewRestaurant: 'Voir la fiche',
    retry: 'Réessayer',
    retryTitle: 'Relancer le traitement',
    retryBody: 'Une nouvelle entrée sera mise en file pour {name}.',
    retryConfirm: 'Réessayer',
    retryFailed: 'Échec du réessai',
    remove: 'Supprimer',
    removeTitle: 'Supprimer cette entrée',
    removeBody: 'Retirer {name} de la file ? Cette action ne peut pas être annulée.',
    removeConfirm: 'Supprimer',
    backToAdmin: 'Retour Admin'
  },
  discover: {
    title: 'Découvrir à proximité',
    subtitle: 'Trouvez des restaurants autour de vous via OpenStreetMap et mettez-les en file de traitement.',
    useMyLocation: 'Utiliser ma position',
    locating: 'Localisation…',
    noGeo: 'La géolocalisation n’est pas disponible sur cet appareil.',
    geoFailed: 'Impossible d’obtenir la position.',
    or: 'ou',
    addressPlaceholder: 'ex. Rue du Rhône 1, Genève (GE ou VD uniquement)',
    useAddress: 'Utiliser cette adresse',
    geocoding: 'Recherche…',
    addressNotFound: 'Adresse introuvable. Essayez une formulation plus précise.',
    addressNotFoundGeVd: 'Adresse introuvable dans les cantons de Genève et Vaud.',
    addressOutOfArea: 'Cette adresse est hors de Genève et Vaud.',
    locationFromGps: 'Position actuelle',
    radius: 'Rayon',
    search: 'Rechercher',
    searching: 'Recherche…',
    searchingWebsite: 'Recherche du site web…',
    retryWebsite: 'Réessayer',
    foundN: '{n} résultat(s)',
    selectAllReady: 'Tout sélectionner ({n})',
    clearSelection: 'Aucun',
    websitePlaceholder: 'https://exemple.ch',
    enqueueBtn: 'Générer les sites sélectionnés ({n})',
    enqueueRunning: 'Envoi…',
    enqueueOkTitle: 'Ajouté à la file',
    enqueueOkBody: '{n} restaurant(s) en attente de traitement.',
    enqueueFailed: 'Échec de la mise en file',
    backToAdmin: 'Retour Admin',
    noResults: 'Aucun restaurant trouvé dans ce rayon.'
  }
}
...
const de = {
  ...
  admin: {
    ...
    discoverBtn: 'In der Nähe entdecken',
    queueTitle: 'Scaffolding-Warteschlange',
    queuePending: '{n} ausstehend',
    queueScaffolding: '{n} laufend',
    queueDone: '{n} bereitgestellt',
    queueFailed: '{n} fehlgeschlagen',
    queueCurrent: 'Aktuell: {name}',
  ...
  queue: {
    title: 'Scaffolding-Warteschlange',
    subtitle: 'Detail der Restaurants in Wartestellung, in Arbeit, fertig oder fehlgeschlagen.',
    empty: 'Die Warteschlange ist leer.',
    bucketScaffolding: 'In Arbeit',
    bucketPending: 'Wartend ({n})',
    bucketDone: 'Bereitgestellt ({n})',
    bucketFailed: 'Fehlgeschlagen ({n})',
    enqueuedAt: 'Hinzugefügt um {t}',
    startedAt: 'Gestartet um {t}',
    finishedAt: 'Fertig um {t}',
    failedAt: 'Fehlgeschlagen um {t}',
    viewRestaurant: 'Datensatz öffnen',
    retry: 'Erneut versuchen',
    retryTitle: 'Scaffolding erneut starten',
    retryBody: 'Ein neuer Eintrag für {name} wird in die Warteschlange gestellt.',
    retryConfirm: 'Erneut versuchen',
    retryFailed: 'Wiederholung fehlgeschlagen',
    remove: 'Entfernen',
    removeTitle: 'Eintrag entfernen',
    removeBody: '{name} aus der Warteschlange entfernen? Dies kann nicht rückgängig gemacht werden.',
    removeConfirm: 'Entfernen',
    backToAdmin: 'Zurück zu Admin'
  },
  discover: {
    title: 'In der Nähe entdecken',
    subtitle: 'Restaurants in Ihrer Umgebung über OpenStreetMap finden und zum Scaffolding in die Warteschlange stellen.',
    useMyLocation: 'Standort verwenden',
    locating: 'Standortbestimmung…',
    noGeo: 'Standortbestimmung auf diesem Gerät nicht verfügbar.',
    geoFailed: 'Standort konnte nicht ermittelt werden.',
    or: 'oder',
    addressPlaceholder: 'z. B. Rue du Rhône 1, Genf (nur GE oder VD)',
    useAddress: 'Diese Adresse verwenden',
    geocoding: 'Suchen…',
    addressNotFound: 'Adresse nicht gefunden. Versuchen Sie eine genauere Angabe.',
    addressNotFoundGeVd: 'Adresse in den Kantonen Genf oder Waadt nicht gefunden.',
    addressOutOfArea: 'Diese Adresse liegt ausserhalb von Genf und Waadt.',
    locationFromGps: 'Aktueller Standort',
    radius: 'Radius',
    search: 'Suchen',
    searching: 'Suchen…',
    searchingWebsite: 'Website wird gesucht…',
    retryWebsite: 'Erneut versuchen',
    foundN: '{n} Ergebnis(se)',
    selectAllReady: 'Alle auswählen ({n})',
    clearSelection: 'Keine',
    websitePlaceholder: 'https://beispiel.ch',
    enqueueBtn: 'Ausgewählte Sites generieren ({n})',
    enqueueRunning: 'Senden…',
    enqueueOkTitle: 'Zur Warteschlange hinzugefügt',
    enqueueOkBody: '{n} Restaurant(s) warten auf Scaffolding.',
    enqueueFailed: 'Hinzufügen zur Warteschlange fehlgeschlagen',
    backToAdmin: 'Zurück zu Admin',
    noResults: 'Keine Restaurants in diesem Radius gefunden.'
  }
}
...
const it = {
  ...
  admin: {
    ...
    discoverBtn: 'Scopri nelle vicinanze',
    queueTitle: 'Coda di scaffolding',
    queuePending: '{n} in attesa',
    queueScaffolding: '{n} in corso',
    queueDone: '{n} pubblicati',
    queueFailed: '{n} falliti',
    queueCurrent: 'In corso: {name}',
  ...
  queue: {
    title: 'Coda di scaffolding',
    subtitle: 'Dettaglio dei ristoranti in attesa, in corso, pubblicati o falliti.',
    empty: 'La coda è vuota.',
    bucketScaffolding: 'In corso',
    bucketPending: 'In attesa ({n})',
    bucketDone: 'Pubblicati ({n})',
    bucketFailed: 'Falliti ({n})',
    enqueuedAt: 'Aggiunto alle {t}',
    startedAt: 'Avviato alle {t}',
    finishedAt: 'Terminato alle {t}',
    failedAt: 'Fallito alle {t}',
    viewRestaurant: 'Apri scheda',
    retry: 'Riprova',
    retryTitle: 'Riavviare lo scaffolding',
    retryBody: 'Una nuova voce per {name} verrà aggiunta alla coda.',
    retryConfirm: 'Riprova',
    retryFailed: 'Riprova fallita',
    remove: 'Rimuovi',
    removeTitle: 'Rimuovere questa voce',
    removeBody: 'Rimuovere {name} dalla coda? L’azione non può essere annullata.',
    removeConfirm: 'Rimuovi',
    backToAdmin: 'Torna ad Admin'
  },
  discover: {
    title: 'Scopri nelle vicinanze',
    subtitle: 'Trova ristoranti intorno a te tramite OpenStreetMap e mettili in coda per lo scaffolding.',
    useMyLocation: 'Usa la mia posizione',
    locating: 'Localizzazione…',
    noGeo: 'Geolocalizzazione non disponibile su questo dispositivo.',
    geoFailed: 'Impossibile ottenere la posizione.',
    or: 'oppure',
    addressPlaceholder: 'es. Rue du Rhône 1, Ginevra (solo GE o VD)',
    useAddress: 'Usa questo indirizzo',
    geocoding: 'Ricerca…',
    addressNotFound: 'Indirizzo non trovato. Prova una formulazione più precisa.',
    addressNotFoundGeVd: 'Indirizzo non trovato nei cantoni di Ginevra o Vaud.',
    addressOutOfArea: 'Questo indirizzo è fuori da Ginevra e Vaud.',
    locationFromGps: 'Posizione attuale',
    radius: 'Raggio',
    search: 'Cerca',
    searching: 'Ricerca…',
    searchingWebsite: 'Ricerca del sito web…',
    retryWebsite: 'Riprova',
    foundN: '{n} risultato(i)',
    selectAllReady: 'Seleziona tutti ({n})',
    clearSelection: 'Nessuno',
    websitePlaceholder: 'https://esempio.ch',
    enqueueBtn: 'Genera siti selezionati ({n})',
    enqueueRunning: 'Invio…',
    enqueueOkTitle: 'Aggiunti alla coda',
    enqueueOkBody: '{n} ristorante(i) in attesa di scaffolding.',
    enqueueFailed: 'Impossibile aggiungere alla coda',
    backToAdmin: 'Torna ad Admin',
    noResults: 'Nessun ristorante trovato in questo raggio.'
  }
}
