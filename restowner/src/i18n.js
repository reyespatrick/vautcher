...
const fr = {
  ...
  admin: {
    ...
    queueTitle: 'File de scaffolding',
    queuePending: '{n} en attente',
    queueScaffolding: '{n} en cours',
    queueDone: '{n} déployé(s)',
    queueFailed: '{n} échec(s)',
    queueCurrent: 'En cours : {name}',
  ...
  queue: {
    title: 'File de scaffolding',
    subtitle: 'Détail des restaurants en attente, en cours, déployés ou en échec.',
    empty: 'La file est vide.',
    bucketScaffolding: 'En cours',
    bucketPending: 'En attente ({n})',
    bucketDone: 'Déployés ({n})',
    ...
    retry: 'Réessayer',
    retryTitle: 'Relancer le scaffolding',
  ...
  discover: {
    ...
    subtitle: 'Trouvez des restaurants autour de vous via OpenStreetMap et mettez-les en file pour scaffolding.',
    ...
    enqueueBtn: 'Mettre en file ({n})',
    enqueueRunning: 'Envoi…',
    enqueueOkTitle: 'Ajouté à la file',
    enqueueOkBody: '{n} restaurant(s) en attente de scaffolding.',
